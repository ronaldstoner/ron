...
![](https://raw.githubusercontent.com/ronaldstoner/ron/gh-pages/images/oct-1997.png)
*stoner.com circa October 1997*
...
Then came the firewall errors. In **March 2004**, the site went down with a "FW-1 at heat" error — a Check Point FireWall-1 message indicating the firewall was overloaded or misconfigured. The site stayed broken for roughly around one to two months before coming back online in May, only to hit another denial error in June. Enterprise IT was an evolving industry at the time, and monitoring, response, and remediation were not as robust as they are today. A lot of times one would know something was down or there was an outage due to a friend telling them "Hey, I tried to get to your site yesterday and couldn't."
